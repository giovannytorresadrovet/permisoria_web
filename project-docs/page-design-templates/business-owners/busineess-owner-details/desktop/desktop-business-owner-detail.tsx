// /components/desktop/owners/BusinessOwnerDetail.jsx
...
const DesktopBusinessOwnerDetail = ({ id }) => {
  ...
  return (
    <div className="bg-gray-900 min-h-screen text-white">
      ...
      <motion.div 
        ...
        className="px-8 py-4 border-b border-gray-800 bg-gray-900 sticky top-0 z-10"
      >
        <div className="container mx-auto">
          <div className="flex flex-row items-center justify-between">
            <div className="flex flex-col">
              ...
              <p className="text-sm text-gray-400 mt-1">{owner.id}</p>
            </div>
      ...
      <div className="container mx-auto px-8 py-6">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <Card className="bg-gray-800 border border-gray-700">
                <div className="p-4">
                  <div className="flex items-center justify-between mb-2">
                    <p className="text-sm text-gray-400">Associated Businesses</p>
                    <Buildings size={20} className="text-blue-400" />
                  </div>
                  <p className="text-2xl font-bold">{owner.businesses.length}</p>
                </div>
              </Card>
          ...
          >
            ...
            >
              <Tabs.List className="bg-gray-900">
                <Tabs.Tab
                  value="overview"
            ...
            <div className="mt-6">
                        ...
                        {owner.historyLogs.slice(0, 3).map((log) => (
                          <div key={log.id} className="border-l-2 border-gray-700 pl-4 py-1">
                            <div className="flex items-center">
                              ...
                              <p className="text-sm text-gray-400">{businessOwnerService.formatDate(log.timestamp)} at {businessOwnerService.formatTime(log.timestamp)}</p>
                            </div>
              ...
              {activeTab === "businesses" && (
                ...
                >
                  ...
                  <Card className="bg-gray-800 border border-gray-700 shadow-md overflow-hidden">
                    <Table className="w-full">
                      <Table.Head className="bg-gray-900">
                        ...
                        <Table.HeadCell>Active Permits</Table.HeadCell>
                        <Table.HeadCell>Actions</Table.HeadCell>
                      </Table.Head>
                      <Table.Body className="divide-y divide-gray-700">
                        {owner.businesses.length > 0 ? (
                          owner.businesses.map((business) => (
                            <Table.Row key={business.id} className="bg-gray-800 hover:bg-gray-750">
                              <Table.Cell>
                                <a 
                              ...
                              <Table.Cell>{business.type}</Table.Cell>
                              ...
                              <Table.Cell>
                                <div className="flex items-center space-x-2">
                                  <Tooltip content="View details" trigger="hover" placement="top">
                                    <a 
                                      href={`/app/businesses/${business.id}`}
                                      className="text-white hover:text-blue-400"
                                    >
                                  ...
                                  <Tooltip content="Unlink business" trigger="hover" placement="top">
                                    <button 
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 p-4">
                      {owner.documents.length > 0 ? (
                        owner.documents.map((document) => {
                          ...
                          return (
                            <Card key={document.id} className="bg-gray-750 border border-gray-700">
                              <div className="p-3">
                                <div className="relative mb-3 bg-gray-700 rounded-md overflow-hidden aspect-[4/3] flex items-center justify-center">
                                  <img 
                                ...
                                <div className="flex justify-between items-center text-xs text-gray-500">
                                  <p>{businessOwnerService.formatDate(document.uploadDate)}</p>
                                  
                                  <div className="flex space-x-2">
                                    <Tooltip content="View document" trigger="hover" placement="top">
                                      <button 
                                    ...
                                    <Tooltip content="Download" trigger="hover" placement="top">
                                      <button className="text-gray-400 hover:text-blue-400">
                                        <DownloadSimple size={16} />
                                      </button>
                                    </Tooltip>
                                    <Tooltip content="Delete" trigger="hover" placement="top">
                      ...
                      <Table className="w-full">
                        ...
                        <Table.Body className="divide-y divide-gray-700">
                          {owner.historyLogs.map((log) => (
                            <Table.Row key={log.id} className="bg-gray-800 hover:bg-gray-750">
                              <Table.Cell>
                                <div className="whitespace-nowrap">
                                  {businessOwnerService.formatDate(log.timestamp)}
                                </div>
                                <div className="text-gray-400 text-xs">
                                  {businessOwnerService.formatTime(log.timestamp)}
                                </div>
                              </Table.Cell>
                              <Table.Cell>
                                <Badge 
...
export default DesktopBusinessOwnerDetail;

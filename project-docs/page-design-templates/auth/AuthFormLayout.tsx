    ...
    <div className="flex flex-col min-h-screen bg-gray-950">
      ...
      <div className="px-4 py-6 flex justify-center md:justify-start md:px-10">
        <Link href="/" className="flex items-center space-x-2 group">
          <div className="w-10 h-10 rounded-full bg-blue-600 group-hover:bg-blue-500 transition-colors duration-200 flex items-center justify-center">
            <img
              src="/logo-icon.svg"
              alt="Permisoria"
              className="w-6 h-6"
          ...
          <span className="text-white font-semibold text-xl group-hover:text-blue-300 transition-colors duration-200">
            Permisoria
          </span>
        </Link>
      </div>
